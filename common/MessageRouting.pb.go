...
func (m *HeartbeatInit) GetDeviceId() string {
...
func (m *UserLogin) GetDeviceId() string {
	if m != nil && m.DeviceId != nil {
		return *m.DeviceId
	}
	return ""
...
func (m *UserOutResponse) Reset()         { *m = UserOutResponse{} }
func (m *UserOutResponse) String() string { return proto.CompactTextString(m) }
func (*UserOutResponse) ProtoMessage()    {}

func (m *UserOutResponse) GetStatus() bool {
	if m != nil && m.Status != nil {
		return *m.Status
	}
	return false
...
func (m *UserOutResponse) GetExtra() string {
	if m != nil && m.Extra != nil {
		return *m.Extra
	}
	return ""
